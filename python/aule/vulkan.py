...
class Aule:
    ...
    def shader_variant_name(self) -> str:
        ...
        names = {
            0: "baseline (emulated, slow)",
            1: "fast",
            2: "fp16",
            3: "fp16_amd",
            4: "bf16 (emulated, slow)",
            5: "bf16_native",
            6: "fp16_native",
    ...
    def set_shader_variant(self, variant: int) -> None:
        ...
        Args:
            variant: Shader variant ID (0=baseline, 1=fast, 2=fp16, 3=fp16_amd, 4=bf16_emulated, 5=bf16_native, 6=fp16_native)
    ...
    def tensor(
        ...
        if dim > 128:
            raise ValueError(f"head_dim must be <= 128, got {dim}")
