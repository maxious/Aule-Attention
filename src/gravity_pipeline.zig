...
/// Push constants for gravity attention shader
pub const GravityPushConstants = extern struct {
    batch_size: u32,
    num_heads: u32,
    seq_len: u32,
    head_dim: u32,
...
pub const GravityPipeline = struct {
    ...
    pub fn init(ctx: *const VulkanContext, shader_code: []const u8) !Self {
        ...
        // Descriptor set layout: Q, K, V, O, Cos, Sin, Indices (7 buffers)
        ...
        const push_constant_range = vk.PushConstantRange{
            .stage_flags = .{ .compute_bit = true },
            .offset = 0,
            .size = @sizeOf(GravityPushConstants),
        };
    ...
    pub fn updateDescriptors(
        ...
        const writes = [_]vk.WriteDescriptorSet{
            .{
                ...
                .p_texel_buffer_view = &dummy_buffer_view,
            },
            .{
                .dst_set = self.descriptor_set,
                .dst_binding = 1,
    ...
    pub fn dispatch(
        ...
        try self.ctx.vkd.queueSubmit(self.ctx.compute_queue, 1, &submits, self.fence);
